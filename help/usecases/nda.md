...
现在，使用[Adobe Sign API](https://developer.adobe.com/adobesign-api/)请求对NDA进行签名，并将最终的已签名文档发送给所有各方。 Adobe Sign使用Webhook[通知您](https://opensource.adobe.com/acrobat-sign/developer_guide/index.html#!adobedocs/adobe-sign/master/webhooks.md)。 侦听此Webhook，您可以获取NDA的状态。
